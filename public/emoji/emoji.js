...
(function () {
    ...
    emoji.prototype.replace_emoticons = function (str) {
        let self = this;
        let colonized = self.replace_emoticons_with_colons(str);
    ...
    */ emoji.prototype.replace_unified = function (
        str,
    ) {
        let self = this;
        self.init_unified();
        return str.replace(self.rx_unified, (m, p1, p2) => {
            let val = self.map.unified[p1];
            if (!val) return m;
            let idx = null;
            if (p2 == '\uD83C\uDFFB') idx = '1f3fb';
            if (p2 == '\uD83C\uDFFC') idx = '1f3fc';
    ...
    /** @private */ emoji.prototype.replacement = function (idx, actual, wrapper, variation) {
        let self = this;
        ...
        if (
            variation_idx &&
            self.variations_data[variation_idx] &&
            self.variations_data[variation_idx][2] &&
            !self.data[idx][7]
        ) {
    ...
    /** @private */ emoji.prototype.init_emoticons = function () {
        let self = this;
    ...
    /** @private */ emoji.prototype.init_unified = function () {
        let self = this;
    ...
    /** @private */ emoji.prototype.init_env = function () {
        let self = this;
    ...
    /** @private */ emoji.prototype.escape_rx = function (text) {
        return text.replace(/[-[\]{}()*+?.,\\^$|#\s]/g, '\\$&');
    };
    emoji.prototype.sheet_size = 41;
    /** @private */ emoji.prototype.data = {
        ...
        '1f1ee-1f1f3': [['\uD83C\uDDEE\uD83C\uDDF3'], '', '', ['flag-in', 'india'], 35, 20, 15, 0],
    ...
    /** @private */ emoji.prototype.emoticons_data = {
        '<3': 'heart',
        ':o)': 'monkey_face',
        ':*': 'kiss',
        ':-*': 'kiss',
    ...
    /** @private */ emoji.prototype.variations_data = {
        '261d-1f3fb': [1, 11, 15],
        '261d-1f3fc': [1, 12, 15],
        '261d-1f3fd': [1, 13, 15],
        '261d-1f3fe': [1, 14, 15],
